...
# Set page title
st.title('🚀 Your **VIZGENIUS** Data Explorer 🎨')

# Main Description
st.write("""
    Welcome to the VIZGENIUS Data Explorer! 
...
st.write("""
    ## Conclusion
    Explore and analyze your data effectively using the VIZGENIUS Interactive Data Explorer!
   ** Upload your CSV file**,** apply interactive filtering**, **visualize data distributions**, **detect outliers**, **export data**, and even **train a dummy classifier**.
    Enjoy exploring your data with ##**VIZGENIUS!**
""")
